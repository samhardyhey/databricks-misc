...
This directory holds the **shared data foundation** for EBOS use cases: synthetic data generators and the **medallion** (bronze → silver → gold) built with dbt. For the phased plan to extend generators and add new tables, see [docs/DATA_GENERATOR_DEV_PLAN.md](../docs/DATA_GENERATOR_DEV_PLAN.md).
